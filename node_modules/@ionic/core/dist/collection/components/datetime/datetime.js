...
import { addTimePadding, getFormattedHour, getMonthAndDay, getMonthAndYear } from './utils/format';
...
export class Datetime {
  ...
  renderYearView() {
    ...
    return (h("div", { class: "datetime-year" },
      h("div", { class: "datetime-year-body" },
        h("div", { class: "datetime-picker-before" }),
        h("div", { class: "datetime-picker-after" }),
        h("div", { class: "datetime-picker-highlight" }),
        showMonth && h("div", { class: "datetime-picker-col month-col", ref: el => this.monthRef = el, tabindex: "0" },
          h("div", { class: "picker-col-item picker-col-item-empty" }, "\u00A0"),
          h("div", { class: "picker-col-item picker-col-item-empty" }, "\u00A0"),
          h("div", { class: "picker-col-item picker-col-item-empty" }, "\u00A0"),
          ...
          h("div", { class: "picker-col-item picker-col-item-empty" }, "\u00A0"),
          h("div", { class: "picker-col-item picker-col-item-empty" }, "\u00A0")),
        showYear && h("div", { class: "datetime-picker-col year-col", ref: el => this.yearRef = el, tabindex: "0" },
          h("div", { class: "picker-col-item picker-col-item-empty" }, "\u00A0"),
          h("div", { class: "picker-col-item picker-col-item-empty" }, "\u00A0"),
          h("div", { class: "picker-col-item picker-col-item-empty" }, "\u00A0"),
  ...
  renderTime(mode) {
    ...
    return (h("div", { class: "datetime-time" },
      h("div", { class: "time-header" }, this.renderTimeLabel()),
      h("div", { class: "time-body" },
        h("div", { class: "time-base", ref: el => this.timeBaseRef = el },
          h("div", { class: "time-wrapper" },
            h("div", { class: "ion-focusable time-column time-column-hours", "aria-label": "Hours", role: "slider", ref: el => this.timeHourRef = el, tabindex: "0" }, hours.map(hour => {
              return (h("div", { class: "time-item", "data-value": getInternalHourValue(hour, use24Hour, ampm) }, getFormattedHour(hour, use24Hour)));
            })),
            h("div", { class: "time-separator" }, ":"),
            h("div", { class: "ion-focusable time-column time-column-minutes", "aria-label": "Minutes", role: "slider", ref: el => this.timeMinuteRef = el, tabindex: "0" }, minutes.map(minute => {
              return (h("div", { class: "time-item", "data-value": minute }, addTimePadding(minute)));
            })))),
        !use24Hour && h("div", { class: "time-ampm" },
          h("ion-segment", { color: mode === 'md' ? this.color : undefined, value: this.workingParts.ampm, onIonChange: (ev) => {
              /**
            ...
            h("ion-segment-button", { disabled: !am, value: "am" }, "AM"),
            h("ion-segment-button", { disabled: !pm, value: "pm" }, "PM"))))));
  }
