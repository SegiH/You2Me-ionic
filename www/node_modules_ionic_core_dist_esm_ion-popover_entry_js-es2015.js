(self["webpackChunkyou2me_ionic"] = self["webpackChunkyou2me_ionic"] || []).push([["node_modules_ionic_core_dist_esm_ion-popover_entry_js"],{
...
/* harmony import */ var _framework_delegate_780bd731_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./framework-delegate-780bd731.js */ 25877);
/* harmony import */ var _helpers_684323ee_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./helpers-684323ee.js */ 18146);
/* harmony import */ var _overlays_0d94a120_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./overlays-0d94a120.js */ 84395);
...
const configureDismissInteraction = (triggerEl, triggerAction, popoverEl, parentPopoverEl) => {
  ...
  const root = (0,_helpers_684323ee_js__WEBPACK_IMPORTED_MODULE_3__.g)(parentPopoverEl);
      ...
      triggerCallbacks = [
        {
          ...
          callback: async (ev) => {
            ...
            hoverTimeout = setTimeout(() => {
              (0,_helpers_684323ee_js__WEBPACK_IMPORTED_MODULE_3__.r)(() => {
...
const focusItem = (item) => {
  const root = (0,_helpers_684323ee_js__WEBPACK_IMPORTED_MODULE_3__.g)(item);
  const button = root.querySelector('button');
  if (button) {
    (0,_helpers_684323ee_js__WEBPACK_IMPORTED_MODULE_3__.r)(() => button.focus());
  }
};
/**
...
const mdEnterAnimation = (baseEl, opts) => {
  ...
  const backdropAnimation = (0,_animation_46ad1639_js__WEBPACK_IMPORTED_MODULE_7__.c)();
  const wrapperAnimation = (0,_animation_46ad1639_js__WEBPACK_IMPORTED_MODULE_7__.c)();
  const contentAnimation = (0,_animation_46ad1639_js__WEBPACK_IMPORTED_MODULE_7__.c)();
  const viewportAnimation = (0,_animation_46ad1639_js__WEBPACK_IMPORTED_MODULE_7__.c)();
  backdropAnimation
    .addElement(root.querySelector('ion-backdrop'))
    .fromTo('opacity', 0.01, 'var(--backdrop-opacity)')
    .beforeStyles({
...
const Popover = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_8fc7a46a_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionPopoverDidPresent", 7);
    this.willPresent = (0,_index_8fc7a46a_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionPopoverWillPresent", 7);
    this.willDismiss = (0,_index_8fc7a46a_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionPopoverWillDismiss", 7);
    this.didDismiss = (0,_index_8fc7a46a_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionPopoverDidDismiss", 7);
    ...
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_0d94a120_js__WEBPACK_IMPORTED_MODULE_4__.B);
    };
  ...
  componentDidLoad() {
    ...
    if (parentPopover) {
      (0,_helpers_684323ee_js__WEBPACK_IMPORTED_MODULE_3__.a)(parentPopover, 'ionPopoverWillDismiss', () => {
  ...
  async present(event) {
    ...
    this.usersElement = await (0,_framework_delegate_780bd731_js__WEBPACK_IMPORTED_MODULE_2__.a)(delegate, this.el, this.component, ['popover-viewport'], data, inline);
    await (0,_index_f51621dd_js__WEBPACK_IMPORTED_MODULE_6__.e)(this.usersElement);
    this.configureKeyboardInteraction();
    this.configureDismissInteraction();
    this.currentTransition = (0,_overlays_0d94a120_js__WEBPACK_IMPORTED_MODULE_4__.d)(this, 'popoverEnter', iosEnterAnimation, mdEnterAnimation, {
    ...
    if (this.focusDescendantOnPresent) {
      (0,_overlays_0d94a120_js__WEBPACK_IMPORTED_MODULE_4__.j)(this.el, this.el);
    }
  }
  /**
  ...
  async dismiss(data, role, dismissParentPopover = true) {
    ...
    this.currentTransition = (0,_overlays_0d94a120_js__WEBPACK_IMPORTED_MODULE_4__.f)(this, data, role, 'popoverLeave', iosLeaveAnimation, mdLeaveAnimation, this.event);
   ...
   */
  onDidDismiss() {
    return (0,_overlays_0d94a120_js__WEBPACK_IMPORTED_MODULE_4__.g)(this.el, 'ionPopoverDidDismiss');
  }
  /**
   * Returns a promise that resolves when the popover will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_0d94a120_js__WEBPACK_IMPORTED_MODULE_4__.g)(this.el, 'ionPopoverWillDismiss');
  }
  render() {
    ...
    const desktop = (0,_ionic_global_e0b8d325_js__WEBPACK_IMPORTED_MODULE_1__.a)('desktop');
    const enableArrow = arrow && !parentPopover && !desktop;
    return ((0,_index_8fc7a46a_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_8fc7a46a_js__WEBPACK_IMPORTED_MODULE_0__.H, Object.assign({ "aria-modal": "true", "no-router": true, tabindex: "-1" }, htmlAttributes, { style: {
        zIndex: `${20000 + this.overlayIndex}`,
      }, id: popoverId, class: Object.assign(Object.assign({}, (0,_theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_5__.g)(this.cssClass)), { [mode]: true, 'popover-translucent': this.translucent, 'overlay-hidden': true, 'popover-interactive': presented, 'popover-desktop': desktop, [`popover-side-${side}`]: true, 'popover-nested': !!parentPopover }), onIonPopoverDidPresent: onLifecycle, onIonPopoverWillPresent: onLifecycle, onIonPopoverWillDismiss: onLifecycle, onIonPopoverDidDismiss: onLifecycle, onIonDismiss: this.onDismiss, onIonBackdropTap: this.onBackdropTap }), !parentPopover && (0,_index_8fc7a46a_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-backdrop", { tappable: this.backdropDismiss, visible: this.showBackdrop, part: "backdrop" }), (0,_index_8fc7a46a_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "popover-wrapper ion-overlay-wrapper", onClick: dismissOnSelect ? () => this.dismiss() : undefined }, enableArrow && (0,_index_8fc7a46a_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "popover-arrow", part: "arrow" }), (0,_index_8fc7a46a_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "popover-content", part: "content" }, (0,_index_8fc7a46a_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null)))));
  }
