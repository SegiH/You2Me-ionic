...
const helpers = require('./helpers-09f4fd32.js');
const theme = require('./theme-30b7a575.js');
const overlays = require('./overlays-f9560fb8.js');
const animation = require('./animation-9fb93536.js');
...
const Datetime = class {
  ...
  renderYearView() {
    ...
    return (index.h("div", { class: "datetime-year" }, index.h("div", { class: "datetime-year-body" }, index.h("div", { class: "datetime-picker-before" }), index.h("div", { class: "datetime-picker-after" }), index.h("div", { class: "datetime-picker-highlight" }), showMonth && index.h("div", { class: "datetime-picker-col month-col", ref: el => this.monthRef = el, tabindex: "0" }, index.h("div", { class: "picker-col-item picker-col-item-empty" }, "\u00A0"), index.h("div", { class: "picker-col-item picker-col-item-empty" }, "\u00A0"), index.h("div", { class: "picker-col-item picker-col-item-empty" }, "\u00A0"), getPickerMonths(this.locale, this.workingParts, this.minParts, this.maxParts, this.parsedMonthValues).map(month => {
      return (index.h("div", { class: "picker-col-item", "data-value": month.value, onClick: (ev) => this.centerPickerItemInView(ev.target, this.monthRef) }, month.text));
    }), index.h("div", { class: "picker-col-item picker-col-item-empty" }, "\u00A0"), index.h("div", { class: "picker-col-item picker-col-item-empty" }, "\u00A0"), index.h("div", { class: "picker-col-item picker-col-item-empty" }, "\u00A0")), showYear && index.h("div", { class: "datetime-picker-col year-col", ref: el => this.yearRef = el, tabindex: "0" }, index.h("div", { class: "picker-col-item picker-col-item-empty" }, "\u00A0"), index.h("div", { class: "picker-col-item picker-col-item-empty" }, "\u00A0"), index.h("div", { class: "picker-col-item picker-col-item-empty" }, "\u00A0"), calendarYears.map(year => {
      return (index.h("div", { class: "picker-col-item", "data-value": year, onClick: (ev) => this.centerPickerItemInView(ev.target, this.yearRef) }, year));
    }), index.h("div", { class: "picker-col-item picker-col-item-empty" }, "\u00A0"), index.h("div", { class: "picker-col-item picker-col-item-empty" }, "\u00A0"), index.h("div", { class: "picker-col-item picker-col-item-empty" }, "\u00A0")))));
  }
  ...
  renderTime(mode) {
    ...
    return (index.h("div", { class: "datetime-time" }, index.h("div", { class: "time-header" }, this.renderTimeLabel()), index.h("div", { class: "time-body" }, index.h("div", { class: "time-base", ref: el => this.timeBaseRef = el }, index.h("div", { class: "time-wrapper" }, index.h("div", { class: "ion-focusable time-column time-column-hours", "aria-label": "Hours", role: "slider", ref: el => this.timeHourRef = el, tabindex: "0" }, hours.map(hour => {
      return (index.h("div", { class: "time-item", "data-value": getInternalHourValue(hour, use24Hour, ampm) }, getFormattedHour(hour, use24Hour)));
    })), index.h("div", { class: "time-separator" }, ":"), index.h("div", { class: "ion-focusable time-column time-column-minutes", "aria-label": "Minutes", role: "slider", ref: el => this.timeMinuteRef = el, tabindex: "0" }, minutes.map(minute => {
      return (index.h("div", { class: "time-item", "data-value": minute }, addTimePadding(minute)));
    })))), !use24Hour && index.h("div", { class: "time-ampm" }, index.h("ion-segment", { color: mode === 'md' ? this.color : undefined, value: this.workingParts.ampm, onIonChange: (ev) => {
        /**
         ...
         */
        ev.stopPropagation();
      } }, index.h("ion-segment-button", { disabled: !am, value: "am" }, "AM"), index.h("ion-segment-button", { disabled: !pm, value: "pm" }, "PM"))))));
  }
  ...
  render() {
    ...
    return (index.h(index.Host, { "aria-disabled": disabled ? 'true' : null, class: Object.assign({}, theme.createColorClasses(color, {
        [mode]: true,
