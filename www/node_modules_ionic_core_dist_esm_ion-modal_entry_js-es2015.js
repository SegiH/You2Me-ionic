...
const createSheetEnterAnimation = (opts) => {
  ...
  const backdropAnimation = (0,_animation_46ad1639_js__WEBPACK_IMPORTED_MODULE_7__.c)('backdropAnimation')
    .fromTo('opacity', 0, initialBackdrop);
  const wrapperAnimation = (0,_animation_46ad1639_js__WEBPACK_IMPORTED_MODULE_7__.c)('wrapperAnimation')
    .keyframes([
...
const iosEnterAnimation = (baseEl, opts) => {
  ...
  const baseAnimation = (0,_animation_46ad1639_js__WEBPACK_IMPORTED_MODULE_7__.c)('entering-base')
    .addElement(baseEl)
  ...
  if (presentingEl) {
    ...
    const presentingAnimation = (0,_animation_46ad1639_js__WEBPACK_IMPORTED_MODULE_7__.c)()
      .beforeStyles({
    ...
    if (isMobile) {
      ...
      if (!hasCardModal) {
        ...
        const shadowAnimation = (0,_animation_46ad1639_js__WEBPACK_IMPORTED_MODULE_7__.c)()
          .afterStyles({
          'transform': finalTransform
        })
...
const iosLeaveAnimation = (baseEl, opts, duration = 500) => {
  ...
  wrapperAnimation
    .addElement(root.querySelectorAll('.modal-wrapper, .modal-shadow'))
    .beforeStyles({ 'opacity': 1 });
  const baseAnimation = (0,_animation_46ad1639_js__WEBPACK_IMPORTED_MODULE_7__.c)('leaving-base')
    .addElement(baseEl)
    .easing('cubic-bezier(0.32,0.72,0,1)')
    .duration(duration)
    .addAnimation(wrapperAnimation);
...
const mdEnterAnimation = (baseEl, opts) => {
  ...
  return (0,_animation_46ad1639_js__WEBPACK_IMPORTED_MODULE_7__.c)()
    .addElement(baseEl)
...
const Modal = class {
  ...
  async present() {
    ...
    (0,_index_8fc7a46a_js__WEBPACK_IMPORTED_MODULE_0__.c)(() => this.el.classList.add('show-modal'));
    this.currentTransition = (0,_overlays_0d94a120_js__WEBPACK_IMPORTED_MODULE_4__.d)(this, 'modalEnter', iosEnterAnimation, mdEnterAnimation, { presentingEl: this.presentingElement, currentBreakpoint: this.initialBreakpoint, backdropBreakpoint: this.backdropBreakpoint });
    await this.currentTransition;
  ...
  initSwipeToClose() {
    ...
    const animationBuilder = this.leaveAnimation || _ionic_global_e0b8d325_js__WEBPACK_IMPORTED_MODULE_1__.c.get('modalLeave', iosLeaveAnimation);
  ...
  initSheetGesture() {
    ...
    const animationBuilder = this.enterAnimation || _ionic_global_e0b8d325_js__WEBPACK_IMPORTED_MODULE_1__.c.get('modalEnter', iosEnterAnimation);
  ...
  async dismiss(data, role) {
    ...
    const enteringAnimation = _overlays_0d94a120_js__WEBPACK_IMPORTED_MODULE_4__.h.get(this) || [];
    this.currentTransition = (0,_overlays_0d94a120_js__WEBPACK_IMPORTED_MODULE_4__.f)(this, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation, { presentingEl: this.presentingElement, currentBreakpoint: this.currentBreakpoint || this.initialBreakpoint, backdropBreakpoint: this.backdropBreakpoint });
  ...
  render() {
    ...
    return ((0,_index_8fc7a46a_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_8fc7a46a_js__WEBPACK_IMPORTED_MODULE_0__.H, Object.assign({ "no-router": true, "aria-modal": "true", tabindex: "-1" }, htmlAttributes, { style: {
        zIndex: `${20000 + this.overlayIndex}`,
      }, class: Object.assign({ [mode]: true, [`modal-card`]: presentingElement !== undefined && mode === 'ios', [`modal-sheet`]: isSheetModal, 'overlay-hidden': true, 'modal-interactive': presented }, (0,_theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_5__.g)(this.cssClass)), id: modalId, onIonBackdropTap: this.onBackdropTap, onIonDismiss: this.onDismiss, onIonModalDidPresent: this.onLifecycle, onIonModalWillPresent: this.onLifecycle, onIonModalWillDismiss: this.onLifecycle, onIonModalDidDismiss: this.onLifecycle }), (0,_index_8fc7a46a_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-backdrop", { ref: el => this.backdropEl = el, visible: this.showBackdrop, tappable: this.backdropDismiss, part: "backdrop" }), mode === 'ios' && (0,_index_8fc7a46a_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "modal-shadow" }), (0,_index_8fc7a46a_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { role: "dialog", class: "modal-wrapper ion-overlay-wrapper", part: "content", ref: el => this.wrapperEl = el }, showHandle && (0,_index_8fc7a46a_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "modal-handle", part: "handle" }), (0,_index_8fc7a46a_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null))));
  }
